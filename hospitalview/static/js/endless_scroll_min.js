...
(function (e) {
 e.fn.endlessScroll = function (t) { function a(e, t, n) {
 ...
 var n = e(this); var r = e(this).attr("id"); 
 var i = t.steps; 
 ...
 var o = e("#" + r + "2"); a(s, o, t.steps > 0);
 var u = setInterval(function () { s.css({ left: parseInt(s.css("left")) + i + "px" });
 o.css({ left: parseInt(o.css("left")) + i + "px" });
 if (parseInt(s.css("left")) < 0 || parseInt(s.css("left")) > s.width()) { a(s, o, t.steps > 0) } }, t.speed); return n } })(jQuery)